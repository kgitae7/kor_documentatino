...
\{% hint style="warning" %\} Support for the Mobile [version 4 SDKs](https://github.com/Adobe-Marketing-Cloud/mobile-services) has ended as of **August 31, 2021** ~~September 30, 2020~~. \{% endhint %\}
...
Solutions such as [Places Service](https://experienceleague.adobe.com/docs/places/using/home.html?lang=en) and Project Griffon are exclusively available on Experience Platform Mobile SDKs.
...
You can continue to use the version 4 SDKs after the end-of-support dates. However, as mentioned in [End-of-support considerations](broken-reference), no support will be provided.

\{% hint style="warning" %\} SDK downloads through GitHub and other locations will be available through **August 31, 2021**. \{% endhint %\}
